...
4. Acquire reference images for the function to look for, must be a graphic that moves with the timeline.  Save this image next to or in a folder next to the script.  I already have the images for Resolve and FL Studio in the examples.
